<nav class="navbar navbar-expand-md navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarsExample04">
    ...
    <?php // SI l'indice 'panier' dans la session est bien définit, alors on calcul la somme de toute les quantités demandé grâce à la fonction prédéfinie array_sum()
    ...
    <?php if(connect()): //accès membre connecté mais NON ADMIN ?>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?= URL ?>profil.php">Motre compte</a>
      </li>
      <li class="nav-item active">
    ...
    <?php if(adminConnect()): // SI l'utilisateur a pour valeur '1' pour le statut dans la session donc dans la BDD, alors il est administrateur du site et nous lui donnons accès aux liens BACKOFFICE ?>
